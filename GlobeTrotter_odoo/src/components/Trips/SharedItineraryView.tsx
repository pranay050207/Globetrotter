...
import { Share2, Copy, Heart, Download, MapPin, Calendar, Clock, DollarSign, Users, Star, Facebook, Twitter, Instagram, Mail, Link, Sparkles, Plane, Globe, Zap, ArrowLeft, Check } from 'lucide-react';
...
const SharedItineraryView: React.FC<SharedItineraryViewProps> = ({ onNavigate }) => {
  ...
  const handleCopyTrip = () => {
    // Navigate to create trip with this itinerary data
    onNavigate(ROUTES.CREATE_TRIP);
  };
